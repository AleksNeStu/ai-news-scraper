 ...
 * absolute URLs in dev (localhost:3000), staging, and production
 * without a rebuild. The trailing-slash strip keeps the resulting
 * paths joinable with a single `/` separator.
 *
 * Used by:
